                    ...
                    <hr>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4" >
                                ...
                                <select name="ministry" id="ministry_id" class="form-control input-lg dynamic" data-dependent='nirdeshanalaya_id'>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="nirdeshanalaya" id="nirdeshanalaya_id" class="form-control input-lg dynamic" data-dependent="karyalaya_id">                                                        
                                    </select>                                                    
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="karyalaya" id="karyalaya_id" class="form-control input-lg dynamic" data-dependent="taha_id">                                                                                                           
                                    </select>                                                    
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">                                    
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="taha" id="taha_id" class="form-control input-lg dynamic" data-dependent="pad_id">                                                        
                                    </select>                                        
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="shreni" id="shreni_id" class="form-control input-lg">                                                                                                                    
